...
import { Heart, MessageCircle, Share2, User, Eye, UserPlus, X } from "lucide-react";
...
const allTrends: Trend[] = [
  ...
  {
    id: 5,
    company: "Digital Africa Hub",
    avatar: "💻",
    timeAgo: "Il y a 15 heures",
    content:
      "Conférence: Digitalisation des PME guinéennes - Comment Sugu-Link accélère votre croissance. Rejoignez-nous le 25 février! 📅 #Digital #PME #Conférence",
    likes: 892,
    comments: 45,
    shares: 134,
    isTrending: true,
  ...
  {
    id: 6,
    company: "Guinée Export Services",
    avatar: "📦",
    timeAgo: "Il y a 1 jour",
    content:
      "Nos exportations ont augmenté de 45% depuis notre inscription sur Sugu-Link! Nous sommes maintenant connectés à plus de 200 donneurs d'ordres. #Export #Success #Growth",
    likes: 1678,
    comments: 92,
    shares: 245,
    isTrending: true,
  ...
  {
    id: 7,
    company: "Construction & Bâtiment Guinea",
    avatar: "🏗️",
    timeAgo: "Il y a 1 jour",
    content:
      "Merci à Sugu-Link pour la transparence et la sécurité des transactions. Nous avons trouvé des partenaires fiables pour nos projets de construction. #Confiance #Partenariat",
    likes: 934,
    comments: 52,
    shares: 178,
    isTrending: false,
  ...
  {
    id: 8,
    company: "SoluTech Guinea",
    avatar: "⚙️",
    timeAgo: "Il y a 2 jours",
    content:
      "Notre dernier webinaire sur la conformité documentaire a rassemblé plus de 500 PME! Merci à tous les participants. Prochain webinaire: Scoring et réputation. #Webinaire #Conformité",
    likes: 1245,
    comments: 78,
    shares: 201,
    isTrending: false,
        ...
        <div className="container">
          <div className="mx-auto mb-14 max-w-2xl text-center">
            ...
            <p className="text-muted-foreground">
              Explorez toutes les publications tendances de la communauté Sugu-Link. Restez informé des success stories,
          ...
          <div className="mt-12 text-center">
            <Button className="rounded-lg px-8 py-6 text-base font-medium hover:shadow-elevated transition-all duration-200">
